...
class Seance extends Model {
    ...
    protected $fillable = ['matiere_id','salle_id','professeur_id','annee_scolaire_id','emploi_du_temps_id','debut','fin','type','statut','is_inter_centre','est_composition','nb_presents_valide','cloture_validee_at','cloture_validee_par'];
    protected $casts = ['debut'=>'datetime','fin'=>'datetime','is_inter_centre'=>'boolean','est_composition'=>'boolean','heure_fin_pause'=>'datetime','heure_scan_professeur'=>'datetime','cloture_validee_at'=>'datetime'];
    ...
    public function contestations() { return $this->hasMany(ContestationHoraire::class); }
